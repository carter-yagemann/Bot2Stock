...
#mkt_close = midnight + pd.to_timedelta('09:30:00.00001') #10000
...
# 200 time steps in...
impact_time = midnight + pd.to_timedelta('09:30:00.0000004') #400
#impact_time = midnight + pd.to_timedelta('09:30:00.00000002')
greed = 0.25
bots = 10
